const { config, Offer, Doctor } = require("../../db/db.js");

const createOffer = async (req, res) => {
  try {
    const { name, sum, doctorId, subCategoryId } = req.body;

    const offer = await Offer.create({ name, sum, doctorId, subCategoryId });
